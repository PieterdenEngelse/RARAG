...
use crate::memory::{AgentMemory, MemoryItem, MemorySearchResult};
use chrono::Utc;
use crate::config::ApiConfig; // â† kept and used
...
// âœ… Updated: now accepts &ApiConfig
pub fn start_api_server(config: &ApiConfig) -> impl std::future::Future<Output = std::io::Result<()>> {
    HttpServer::new(|| {
        ...
        App::new()
            ...
            .configure(crate::api::decision_engine_routes::configure_decision_engine_routes)
    })
