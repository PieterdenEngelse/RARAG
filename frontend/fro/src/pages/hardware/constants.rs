...
pub const PARAM_LABEL_CLASS_TIGHT: &str = "text-gray-400 whitespace-nowrap inline-block mb-[-1.5mm]";
...
pub const PARAM_TEXT_INPUT_CLASS: &str = "input input-xs input-bordered bg-gray-700 text-gray-200 w-72";
