...
pub fn Header() -> Element {
    ...
    let is_dark = match try_use_context::<Signal<bool>>() {
        Some(signal) => signal(),
        None => true,
    };
    ...
    rsx! {
        header {
            class: "sticky top-0 shadow-md p-0.5 z-50 transition-colors {header_bg} flex items-center justify-between",
            ...
            div {
                class: "container mx-auto flex flex-1 justify-end items-center",
